...
export function SectionSkills(props: ISectionSkillsProps) {
  ...
  const onPageChange = (page:number) => {
    setPaginatedSkills(calculatePaginatedSkills(page));
  }

  const [paginatedSkills, setPaginatedSkills] = useState<ISkill[]>(calculatePaginatedSkills(1))
  ...
  return (
    <section id="skills" {...restProps} >
      ...
      <Pagination items={skills} onPageChange={onPageChange} />
    </section>
  );
}